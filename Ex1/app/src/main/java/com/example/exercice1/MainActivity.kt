...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBleu.setOnClickListener {
            myLayout.setBackgroundColor(Color.BLUE)  // Change l'arrière-plan en bleu
        ...
        btnVert.setOnClickListener {
            myLayout.setBackgroundColor(Color.GREEN)  // Change l'arrière-plan en vert
        ...
        btnRouge.setOnClickListener {
            myLayout.setBackgroundColor(Color.RED)  // Change l'arrière-plan en rouge
